...
UUID = os.environ.get('UUID', 'e2f9d45a-8b3c-4d1e-9a2f-6b7c8d9e0f1a')   # Generated New UUID
...
# Suppress standard http access logs
...
uuid: {UUID}"""
    ...
    try:
        ...
        logger.info('Nezha agent started successfully')
    except Exception as e:
        logger.error(f'Error running Nezha agent: {e}')
